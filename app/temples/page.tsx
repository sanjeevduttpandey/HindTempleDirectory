...
const temples = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 105,
    image: "/images/bharatiya-mandir-exterior.jpg",
    description:
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 67,
    image: "/images/hamilton-shiva-temple.jpg",
  ...
  },
  {
    ...
    rating: 4.4,
    reviews: 45,
    image: "/images/tauranga-hindu-society.jpg",
  ...
  },
  {
    ...
    rating: 4.3,
    reviews: 38,
    image: "/images/dunedin-hindu-temple.jpg",
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Hindu Temples Directory</p>
              </div>
            </Link>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4">Hindu Temples in New Zealand</h2>
      ...
      <section className="py-12 px-4 bg-orange-50">
        <div className="container mx-auto text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Help us build a comprehensive directory of Hindu temples in New Zealand. Submit temple information to help
