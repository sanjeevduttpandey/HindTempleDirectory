    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Wellington Sanatan Temples</p>
            </div>
          </Link>
        </div>
      </header>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4">Sanatan Temples in Wellington</h2>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-gray-600 leading-relaxed">
            Wellington, New Zealand's capital city, hosts a vibrant Sanatan community with several temples and cultural
        ...
        <div className="container mx-auto">
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">
              {wellingtonTemples.length} Sanatan Temples & Cultural Centers
            </h3>
