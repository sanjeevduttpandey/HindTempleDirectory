  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-orange-800 text-center mb-8">Sanatan Festivals Calendar</h1>
        <p className="text-xl text-center text-gray-700 mb-12 max-w-3xl mx-auto">
          Explore the rich tapestry of Sanatan festivals and celebrations across New Zealand for the years 2024-2026.
        </p>
        ...
        <div className="mt-12 bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Understanding Sanatan Festivals</h2>
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Sanatan festivals are celebrated based on the Sanatan lunar calendar, which is why their dates on the
            ...
            <p className="mb-4">
              ...
              Sanatan community. They often involve special prayers, rituals, community gatherings, cultural
              performances, and traditional foods.
            </p>
            <p>
